...
(
    ...
    function () 
    {
        ...
        if(!inputdate)
        {
            Swal.fire("Please Choose a Date","","info");
        }
        else 
        {
            ...
            var formattedDate = 
                        ...
                        split('-').reverse().join('-')+', '+
                        getWeekDay(lastDayOfNextMonth.getDay())+" is the next monthend";
...
(
    ...
    function()
    {
        ...
        else 
        {
            ...
            var formattedDate = 
                    lastFridayDate.toISOString().split('T')[0].
                    split('-').reverse().join('-')+', '+ 
                    getWeekDay(lastFridayDate.getDay())+" is the next month weekend";
            document.getElementById("resultText").innerHTML = formattedDate;
        }
        ...
        if(!inputdate)
            ...
            else 
            {
                ...
                var formattedDate =  inputdate.toISOString().
                        ...
                        getWeekDay(inputdate.getDay())+" is the next weekend"
                document.getElementById("resultText").innerHTML =formattedDate;
            }
            ...
            (async () => {
                ...
                if (numberofDays) 
                {
                    ...
                    else 
                    {
                        ...
                        {
                            nthDayOfNextMonth = new Date(
                                    nextYear,
                                    nthDayOfNextMonth.getMonth(),
                                    numberofDays,23 );
                        }
                        var formattedDate = nthDayOfNextMonth.toISOString().
                                split('T')[0].split('-').reverse().join('-')+', '+
                                getWeekDay(nthDayOfNextMonth.getDay());
                        document.getElementById("resultText").innerHTML = formattedDate;
                    }
                }
            })()
            ...
            if (numberofDays) 
            {
                ...
                else 
                {
                    ...
                    while (numberofDays>0) 
                    {
                        ...
                        if(presentDate==6 || presentDate==0)
                        {
                            console.log(inputdate);
                            continue;
                        }              
